    ...
    public function actionGetarchiwum(){
        ...
        for($i=0;$i<count($archi);$i++){
            ...
            $res[] = [
                ...
                'nazwisko' => isset($client->nazwisko) ? $client->nazwisko : null,
                'nazwa_skrocona' => $client->isset($client->nazwa_skrocona) ? $client->nazwisko : null,
                'miejscowosc' => $client->isset($client->miejscowosc) ? $client->nazwisko : null,
                'kod_pocztowy' => $client->isset($client->kod_pocztowy) ? $client->nazwisko : null,
                'poczta' => $client->isset($client->poczta) ? $client->nazwisko : null,
                'ulica' => $client->isset($client->ulica) ? $client->nazwisko : null,
                'nr_domu' => $client->isset($client->nr_domu) ? $client->nazwisko : null,
                'nr_lokalu' => $client->isset($client->nr_lokalu) ? $client->nazwisko : null,
                'nip' => $client->isset($client->nip) ? $client->nazwisko : null,
                'email' => $client->isset($client->email) ? $client->nazwisko : null,
                'telefon' => $client->isset($client->telefon) ? $client->nazwisko : null,
            ];
        }
        return[
            'error' => false,
