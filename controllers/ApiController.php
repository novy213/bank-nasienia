    ...
    public function actionGetarchiwum(){
        ...
        for($i=0;$i<count($archi);$i++){
            ...
            $res[] = [
                ...
                'nazwa_skrocona' => isset($client->nazwa_skrocona) ? $client->nazwisko : null,
                'miejscowosc' => isset($client->miejscowosc) ? $client->nazwisko : null,
                'kod_pocztowy' => isset($client->kod_pocztowy) ? $client->nazwisko : null,
                'poczta' => isset($client->poczta) ? $client->nazwisko : null,
                'ulica' => isset($client->ulica) ? $client->nazwisko : null,
                'nr_domu' => isset($client->nr_domu) ? $client->nazwisko : null,
                'nr_lokalu' => isset($client->nr_lokalu) ? $client->nazwisko : null,
